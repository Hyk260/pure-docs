import{_ as s,c as n,o as a,a4 as p}from"./chunks/framework.BG254jyF.js";const g=JSON.parse('{"title":"目录结构","description":"","frontmatter":{},"headers":[],"relativePath":"guide/directory.md","filePath":"guide/directory.md","lastUpdated":1709863524000}'),e={name:"guide/directory.md"},l=p(`<h1 id="目录结构" tabindex="-1">目录结构 <a class="header-anchor" href="#目录结构" aria-label="Permalink to &quot;目录结构&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>├── .vscode                    // 编辑器配置</span></span>
...
<span class="line"><span>└── vue.config.js              // vue配置文件</span></span></code></pre></div>`,2),i=[l];function c(t,o,r,d,_,m){return a(),n("div",null,i)}const v=s(e,[["render",c]]);export{g as __pageData,v as default};
